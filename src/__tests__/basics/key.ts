...
describe("Keys", () => {
	describe("Create public key", () => {
		...
		//This one is actually invalid, but we claim it was already verified (used for optimalization), thus it should work.
		it("already verified", () => expect(() => new PublicKey(Buffer.from("02ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", "hex"), true)).not.toThrow());
	});
